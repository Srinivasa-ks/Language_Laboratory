...
export const PHONEMES: Phoneme[] = [
  // ───────────────────────── MONOPHTHONGS (12) ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/ði ˈiːɡl fluz diːp ˈəʊvə ðə ɡriːn fiːld/", "The eagle flies deep over the green field."),
      d("/wi niːd tə spiːk wið ðə pəˈliːs əˈfɪsə/", "We need to speak with the police officer."),
      d("/ʃi wz ˈfiːlɪŋ ˈiːɡə tə liːv ðə ˈpaːti/", "She was feeling eager to leave the party."),
      d("/maɪ ˈpiːpl ɑː ˈiːtn ˈiːzl fɪʃ/", "My people are eating eelish fish."),
      d("/ðə ˈiːst wɪnd bluz strɒŋli ˈiːli/", "The east wind blows strongly, eerily."),
      d("/pleziːz siː ðə ˈtiːtʃə biˈtwiːn θriː/", "Please see the teacher between three."),
      d("/aɪ biˈliːv wi ʃiːld əˈɡriː tə miːt/", "I believe we should agree to meet."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bɪl sæt ɒn ðə ˈlɪtl stɛp wɪð hɪz kɪt/", "Bill sat on the little step with his kit."),
      d("/wɪn wɪl ˈvɪzɪt hɪz ˈsɪstər ɪn ˈbrɪtən/", "Win will visit his sister in Britain."),
      d("/ðɪk fɪlmz ɪn lɪst ˈɔːdə ɑː ˈpɜːfɪkt/", "Thick films in list order are perfect."),
      d("/ɪts ɪmˈpɒsəbl tə fɪks ɪt ˈɪnstəntli/", "It's impossible to fix it instantly."),
      d("/ˈsɪmpl saɪnz hɛlp ɪn ˈdɪfɪkəlt ˌsɪtʃuˈeɪʃənz/", "Simple signs help in difficult situations."),
      d("/bɪˈɡɪn ɪn smɔːl ˈsɪtiz fɜːst/", "Begin in small cities first."),
      d("/ˈmɪsɪz smɪθ lɪvz nɪə ðə ˈlɪmɪt/", "Mrs Smith lives near the limit."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bed/", "The bed is soft and comfortable."),
      d("/frend/", "My best friend lives nearby."),
      d("/hed/", "He hit his head on the low door."),
      d("/men/", "Ten men entered the red tent."),
      d("/leg/", "She broke her leg playing football."),
      d("/desk/", "Put the pen on the wooden desk."),
      d("/wel/", "We said farewell at the well."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/kæt/", "The black cat sat on the mat."),
      d("/hænd/", "Give me your hand and hold tight."),
      d("/bæg/", "She packed her bag for the trip."),
      d("/flæt/", "They live in a small flat downtown."),
      d("/mæn/", "That man can fix any car."),
      d("/læmp/", "Turn on the lamp when it gets dark."),
      d("/bæθ/", "The bath water is too hot."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/kʌp/", "Could you pass me that cup?"),
      d("/sʌn/", "The sun shines brightly today."),
      d("/mʌðə/", "My mother makes the best cake."),
      d("/lʌv/", "Love makes the world go round."),
      d("/brʌðə/", "His brother studies at university."),
      d("/ʌndə/", "The cat hid under the table."),
      d("/kʌlə/", "What colour is your new dress?"),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/dɒɡ/", "The dog barked at the postman."),
      d("/klɒk/", "Look at the clock on the wall."),
      d("/bɒks/", "Open the box and see inside."),
      d("/stɒp/", "Please stop at the next station."),
      d("/ʃɒp/", "She went shopping at the local shop."),
      d("/lɒt/", "There is a lot of work to do."),
      d("/hɒt/", "The tea is too hot to drink."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bʊk/", "I read a good book last night."),
      d("/fʊt/", "He hurt his foot playing rugby."),
      d("/ɡʊd/", "That is a very good idea."),
      d("/wʊd/", "Would you like some wood for the fire?"),
      d("/pʊʃ/", "Push the door gently please."),
      d("/lʊk/", "Look at that beautiful view."),
      d("/kʊk/", "Can you cook dinner tonight?"),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/əˈbaʊt/", "Tell me about your holiday."),
      d("/ˈtiːtʃə/", "The teacher explained the lesson."),
      d("/bəˈnɑːnə/", "She ate a banana for breakfast."),
      d("/ˈdɒktə/", "The doctor gave good advice."),
      d("/ˈsəʊfə/", "Sit on the comfortable sofa."),
      d("/əˈɡen/", "Please say that again slowly."),
      d("/ˈkæmrə/", "He took photos with his camera."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bluː/", "The sky is clear and blue."),
      d("/suːp/", "Would you like some hot soup?"),
      d("/truː/", "Is that story really true?"),
      d("/ʃuː/", "These shoes are too small."),
      d("/muːn/", "The moon looks beautiful tonight."),
      d("/ɡruːp/", "Our group won the competition."),
      d("/luːz/", "Don't lose your house keys."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/dɔː/", "Close the door behind you."),
      d("/fɔː/", "He walked for four miles."),
      d("/hɔːs/", "The horse ran across the field."),
      d("/bɔːl/", "Kick the ball into the net."),
      d("/wɔː/", "The war ended many years ago."),
      d("/lɔː/", "The law must be obeyed by all."),
      d("/θɔːt/", "I thought you were coming today."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bɜːd/", "The bird sang sweetly this morning."),
      d("/ɡɜːl/", "That girl plays piano beautifully."),
      d("/wɜːk/", "She goes to work by bus."),
      d("/nɜːs/", "The nurse cared for the patients."),
      d("/lɜːn/", "Children learn quickly at this age."),
      d("/ɜːθ/", "The earth orbits around the sun."),
      d("/pɜːl/", "The pearl necklace was very valuable."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/kɑː/", "The car needs washing."),
      d("/fɑː/", "How far is it to London?"),
      d("/pɑːk/", "Let's have a picnic in the park."),
      d("/stɑː/", "The star twinkled in the night sky."),
      d("/ɡlɑːs/", "She wore dark glasses in the sun."),
      d("/fɑːðə/", "My father works in an office."),
      d("/pɑːst/", "Half past three is tea time."),
    ],
  },
  ...
  // ───────────────────────── DIPHTHONGS (8) ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/deɪ/", "What day is it today?"),
      d("/weɪ/", "This is the way we do it."),
      d("/seɪ/", "Can you say that again?"),
      d("/peɪ/", "Please pay the bill today."),
      d("/meɪ/", "May I make a suggestion?"),
      d("/treɪ/", "The train left the station."),
      d("/pleɪ/", "Let's play a game outside."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/maɪ/", "This is my favourite book."),
      d("/baɪ/", "Buy some bread at the shop."),
      d("/laɪ/", "Don't lie to your friends."),
      d("/haɪ/", "How high can you jump?"),
      d("/flaɪ/", "Birds fly south for winter."),
      d("/traɪ/", "Try harder next time."),
      d("/waɪ/", "Why did you do that?"),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/tɔɪ/", "The toy broke yesterday."),
      d("/bɔɪ/", "That boy is very tall."),
      d("/nɔɪz/", "Don't make so much noise."),
      d("/vɔɪs/", "She has a lovely voice."),
      d("/dʒɔɪ/", "It brings me great joy."),
      d("/sɔɪl/", "The soil is rich and dark."),
      d("/kɔɪn/", "I found a coin on the ground."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ɡəʊ/", "We should go home now."),
      d("/ʃəʊ/", "Let me show you how."),
      d("/bəʊt/", "The boat sailed away."),
      d("/rəʊd/", "Walk along the road."),
      d("/həʊp/", "I hope to see you soon."),
      d("/nəʊz/", "He broke his nose."),
      d("/θrəʊ/", "Don't throw that away."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/haʊs/", "They live in a big house."),
      d("/maʊθ/", "Open your mouth wide."),
      d("/naʊ/", "We need to leave now."),
      d("/daʊn/", "Sit down please."),
      d("/taʊn/", "The town is very old."),
      d("/klaʊd/", "There's a cloud in the sky."),
      d("/aʊt/", "Let's go out for dinner."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/hɪər/", "Can you hear that sound?"),
      d("/nɪər/", "We're nearly there now."),
      d("/jɪər/", "A year has twelve months."),
      d("/fɪər/", "Don't fear the unknown."),
      d("/dɪər/", "That deer is in the forest."),
      d("/bɪər/", "Would you like a beer?"),
      d("/klɪər/", "The water is clear and clean."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/weər/", "What are you wearing?"),
      d("/heər/", "She has long hair."),
      d"/beər/", "The bear lives in the woods."),
      d("/steər/", "Don't stare at people."),
      d("/feər/", "I'm afraid of the dark."),
      d("/peər/", "That's a fair decision."),
      d("/tʃeər/", "Pull up a chair."),
      d("/feər/", "Fair play wins the game."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/jʊər/", "Is this your book?"),
      d("/tʊər/", "We toured the castle."),
      d("/pʊər/", "The poor need our help."),
      d("/ʃʊər/", "Are you sure about that?"),
      d("/mʊər/", "The moor was misty."),
      d("/bʊər/", "He bored the audience."),
      d("/lʊər/", "The lure was tempting."),
    ],
  },
  ...
  // ───────────────────────── TRIPHTHONGS (5) ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/pleɪə/", "The player scored a goal."),
      d("/ɡreɪtə/", "This is greater than before."),
      d("/leɪjə/", "Add another layer on top."),
      d("/steɪə/", "Stay here for a while."),
      d("/peɪdʒə/", "Turn to the next page."),
      d("/weɪvə/", "Watch the wave approach."),
      d("/deɪtə/", "Check the data carefully."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/faɪə/", "The fire burned brightly."),
      d("/taɪə/", "I'm tired after work."),
      d("/laɪə/", "Don't be such a liar."),
      d("/saɪə/", "Science explains the world."),
      d("/draɪə/", "Use the dryer for clothes."),
      d("/aɪəriən/", "An iron will helps succeed."),
      d("/vaɪərəl/", "The video went viral."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/plɔɪə/", "The employer hired staff."),
      d("/dʒɔɪə/", "Rejoice in good news."),
      d("/nɔɪzi/", "The noisy children played."),
      d("/bɔɪlə/", "Boil the water first."),
      d("/kɔɪlə/", "Coil the rope neatly."),
      d("/spɔɪlə/", "Don't spoil the surprise."),
      d("/ɔɪstə/", "Oysters are delicious."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ləʊə/", "Lower your voice please."),
      d("/ɡəʊə/", "Go over there now."),
      d("/ʃəʊə/", "Show me the way."),
      d("/məʊə/", "More effort is needed."),
      d("/bəʊə/", "Borrow some money."),
      d("/θrəʊə/", "Throw it away."),
      d("/fləʊə/", "The flower bloomed."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/haʊə/", "How are you today?"),
      d("/aʊə/", "Our house is nearby."),
      d("/klaʊə/", "A cloud blocked the sun."),
      d("/taʊə/", "The tower is very tall."),
      d("/raʊə/", "The rough surface scratched."),
      d("/maʊə/", "Move it over there."),
      d("/ðaʊə/", "Thou shalt not steal."),
    ],
  },
  ...
  // ───────────────────────── PLOSIVES ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/pɛn/", "Please pass me that pen."),
      d("/pɪg/", "The pig rolled in the mud."),
      d("/pɑːk/", "Let's park the car here."),
      d("/peɪ/", "Can you pay the bill?"),
      d("/piːs/", "This piece of cake is delicious."),
      d("/pʊʃ/", "Push the door gently."),
      d("/pleɪ/", "Children love to play outside."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/bed/", "I need a new bed."),
      d("/bæg/", "Where is my bag?"),
      d("/bɔːl/", "Kick the ball hard."),
      d("/baɪ/", "Goodbye for now."),
      d("/biː/", "Be careful on the road."),
      d("/bʊk/", "Book your ticket early."),
      d("/blaɪnd/", "He is blind in one eye."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/tiː/", "Tea time is at four."),
      d("/tæp/", "Turn on the tap."),
      d("/tuː/", "Two plus two equals four."),
      d("/taɪm/", "What time is it?"),
      d("/teɪk/", "Take this with you."),
      d("/tɜːn/", "Turn left at the corner."),
      d("/traɪ/", "Try your best today."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/deɪ/", "See you another day."),
      d("/dɒɡ/", "The dog needs walking."),
      d("/duː/", "What should I do?"),
      d("/daɪ/", "Don't die of curiosity."),
      d("/diːp/", "The water is very deep."),
      d("/dɜː/", "The earth spins on its axis."),
      d("/draɪv/", "Can you drive a car?"),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/kiː/", "Where are my keys?"),
      d("/kæt/", "The cat caught a mouse."),
      d("/kʊk/", "Who will cook tonight?"),
      d("/kaɪt/", "Fly the kite high."),
      d("/keɪk/", "She baked a chocolate cake."),
      d("/klaɪm/", "Climb the mountain slowly."),
      d("/kraɪ/", "Don't cry over spilt milk."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ɡəʊ/", "Ready, steady, go!"),
      d("/ɡæs/", "Turn off the gas."),
      d("/ɡʊd/", "That's very good of you."),
      d("/ɡaɪ/", "He's a nice guy."),
      d("/ɡeɪm/", "Let's play a game."),
      d("/ɡlæs/", "My glass is empty."),
      d("/ɡreɪ/", "The sky turned grey."),
    ],
  },
  ...
  // ───────────────────────── NASALS ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/miː/", "Come with me."),
      d("/mæn/", "That man is tall."),
      d("/maʊθ/", "Open your mouth."),
      d("/meɪk/", "Make yourself at home."),
      d("/miːt/", "Nice to meet you."),
      d("/mʌni/", "Save your money."),
      d("/maɪ/", "This is my house."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/naʊ/", "Do it now."),
      d("/net/", "The net caught the ball."),
      d("/naɪt/", "Good night, sleep well."),
      d("/neɪm/", "What's your name?"),
      d("/niːd/", "I need some help."),
      d("/nəʊ/", "No, thank you."),
      d("/njuː/", "This is brand new."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/sɪŋ/", "Sing us a song."),
      d("/rɪŋ/", "Did the phone ring?"),
      d("/lɒŋ/", "The road is very long."),
      d("/strɒŋ/", "Stay strong and brave."),
      d("/θɪŋk/", "Think before you speak."),
      d("/brɪŋ/", "Bring it tomorrow."),
      d("/hæŋ/", "Hang your coat there."),
    ],
  },
  ...
  // ───────────────────────── FRICATIVES ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/fiːt/", "My feet are cold."),
      d("/fæn/", "She's a big fan."),
      d("/faɪnd/", "Can you find it?"),
      d("/feɪs/", "Wash your face."),
      d("/fuːd/", "I love Italian food."),
      d("/friː/", "Are you free tonight?"),
      d("/flaɪ/", "Watch the bird fly."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/veri/", "Thank you very much."),
      d("/væn/", "The van is parked outside."),
      d("/vaɪs/", "Smoking is a bad vice."),
      d("/veɪn/", "Wait in the vain hope."),
      d("/viː/", "Roman numeral five."),
      d("/vɪzɪt/", "We'll visit soon."),
      d("/vɒɪs/", "Raise your voice."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/θɪŋk/", "Think carefully about it."),
      d("/θruː/", "Walk through the door."),
      d("/θriː/", "One, two, three."),
      d("/θɜːd/", "She came in third."),
      d("/θɪn/", "The ice is thin."),
      d("/θæŋks/", "Thanks for your help."),
      d("/tuːθ/", "Brush your teeth daily."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ðɪs/", "This is amazing."),
      d("/ðæt/", "Look at that!"),
      d("/ðeɪ/", "They are coming later."),
      d("/ðeə/", "Their house is big."),
      d("/ðəm/", "Give it to them."),
      d("/ðen/", "And then what happened?"),
      d("/ðəʊz/", "Those are mine."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/siː/", "Can you see me?"),
      d("/set/", "Set the table please."),
      d("/saɪz/", "What size do you wear?"),
      d("/seɪ/", "What did you say?"),
      d("/suːp/", "The soup is hot."),
      d("/sliːp/", "I need to sleep."),
      d("/staɪl/", "She has great style."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/zuː/", "Visit the zoo today."),
      d("/zɒn/", "This is a no-go zone."),
      d("/zeɪ/", "Zip it up."),
      d("/ziːl/", "He works with zeal."),
      d("/zɪp/", "Close the zip."),
      d("/zɒdiæk/", "What's your zodiac sign?"),
      d("/breɪz/", "Face the breeze."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ʃiː/", "She loves flowers."),
      d("/ʃɒp/", "Let's go shopping."),
      d("/ʃuː/", "Put on your shoes."),
      d("/ʃaɪn/", "The sun will shine."),
      d("/ʃeɪp/", "Get in shape."),
      d("/ʃɪp/", "The ship sails tomorrow."),
      d("/ʃʊət/", "Shut the window."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/ʒɒn/", "Jean wears blue."),
      d("/ʒɑːn/", "Jacques is French."),
      d("/leʒə/", "Live at leisure."),
      d("/viʒn/", "A beautiful vision."),
      d("/məʒə/", "Measure twice, cut once."),
      d("/kəlaʒ/", "Create a collage."),
      d("/prestiʒ/", "Work brings prestige."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/hiː/", "Is he coming?"),
      d("/hæt/", "Wear a hat today."),
      d("/haʊs/", "Welcome to our house."),
      d("/heɪ/", "Hey, how are you?"),
      d("/hɜː/", "Hear me out."),
      d("/həʊp/", "Never lose hope."),
      d("/hænd/", "Hold my hand."),
    ],
  },
  ...
  // ───────────────────────── AFFRICATES ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/tʃɔɪs/", "Make a wise choice."),
      d("/tʃɜːtʃ/", "The church is old."),
      d("/tʃiːz/", "I like cheese."),
      d("/tʃaɪld/", "Every child matters."),
      d("/tʃeɪn/", "The chain broke."),
      d("/tʃek/", "Check the details."),
      d("/tʃeər/", "Sit in the chair."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/dʒɒb/", "He found a job."),
      d("/dʒʌmp/", "Jump over the puddle."),
      d("/dʒuːn/", "June is warm."),
      d("/dʒaɪlənt/", "Giants are mythical."),
      d("/dʒeɪl/", "Justice was served."),
      d("/dʒɔɪ/", "It brings me joy."),
      d("/dʒɪndʒə/", "Ginger adds flavour."),
    ],
  },
  ...
  // ───────────────────────── APPROXIMANTS ─────────────────────────
  {
    ...
    sentences: [
      ...
      d("/wiː/", "We are friends."),
      d("/wɒnt/", "I want ice cream."),
      d("/waɪ/", "Why not try?"),
      d("/weɪ/", "Show me the way."),
      d("/wɜːk/", "Hard work pays off."),
      d("/wɪn/", "We will win."),
      d("/wɔːtə/", "Drink more water."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/red/", "Red is my favourite."),
      d("/rʌn/", "Run to the shop."),
      d("/raɪt/", "You're absolutely right."),
      d("/reɪn/", "The rain stopped."),
      d("/riːd/", "Read this book."),
      d("/ruːm/", "Make some room."),
      d("/rəʊd/", "Mind the road."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/juː/", "Use it wisely."),
      d("/jɒŋ/", "She's very young."),
      d("/jes/", "Yes, I agree."),
      d("/jeə/", "Your seat is here."),
      d("/jestədeɪ/", "Yesterday was sunny."),
      d("/juːniən/", "He's my junior."),
      d("/juːnivɜːs/", "Explore the universe."),
    ],
  },
  {
    ...
    sentences: [
      ...
      d("/laɪf/", "Life is beautiful."),
      d("/lʌv/", "Love conquers all."),
      d("/laɪk/", "I like that idea."),
      d("/leɪt/", "Don't be late."),
      d("/liːv/", "When do you leave?"),
      d("/lɒŋ/", "It took so long."),
      d("/laɪt/", "Turn on the light."),
    ],
  },
];
